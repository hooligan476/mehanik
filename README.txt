...
кнопка (назад к товарам) не работает
кнопка удалить не работает(переходит на авторизацию)
после удаление товара надо удалить фото из папки uploads/products